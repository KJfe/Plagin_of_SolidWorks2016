...
namespace Plagin_SolidWorks_v2016
{
    class Rounding:IBuildFigure
    {
        ...
        public Rounding(IModelDoc2 swModel, double radiiArray0, double dist2Array0,  double conicRhosArray0, bool setBackArray0, int pointArray0/*, double pointDist2Array0*/, int pointRhoArray0)
        {
            _swModel = swModel;
